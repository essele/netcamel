...
local function ntp_commit(changes)
	...
	if #interfaces > 0 then
		for interface in each(interfaces) do
...
local function ntp_precommit(changes)
	...
	--
	if CF_new["service/ntp/enable"] ~= true then return true end
	...
	--
	if CF_new["service/ntp/provide-service"] ~= true then return true end
	local interfaces = CF_new["service/ntp/listen-on"] or {}
